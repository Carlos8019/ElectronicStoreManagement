...
export const ADD_SERVICE_TO_PRESALE="ADD_SERVICE_TO_PRESALE";
...
export const DELETE_SERVICE_OF_PRESALE="DELETE_SERVICE_OF_PRESALE";
...
export const CLEAR_PRESALE_ARRAYS="CLEAR_PRESALE_ARRAYS";
